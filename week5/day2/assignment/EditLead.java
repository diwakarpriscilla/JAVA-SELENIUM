...
public class EditLead extends BaseClass {
	...
	public void runEditLead(String phNum, String comName) throws InterruptedException {
	...
	public String[][] sendData() throws IOException{
		ReadExcelDataProvider input = new ReadExcelDataProvider();
		return input.readData("EditLeadExcelData");
